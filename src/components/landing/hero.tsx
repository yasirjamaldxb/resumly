        ...
        <div className="grid lg:grid-cols-[1fr_380px] gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-[17px] text-neutral-50 mb-8 leading-relaxed max-w-[460px]">
              Paste any job link or description and Resumly builds everything you need to apply: tailored resume, cover letter, ATS optimization, and application tracking. All in under 60 seconds.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-x-5 gap-y-2">
              ...
              <span className="text-neutral-20">·</span>
              <span className="text-[12px] text-neutral-40 font-medium">Ready in 60 seconds</span>
            </div>
          </div>
