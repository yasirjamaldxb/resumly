...
const faqs = [
  ...
  { q: 'How does Resumly pricing work?', a: 'Your first complete application — resume, AI optimization, and cover letter — is included so you can experience the quality. After that, upgrade to Starter ($4.99/mo) for 10 applications or Pro ($9.99/mo) for unlimited applications, cover letters, and interview prep.' },
