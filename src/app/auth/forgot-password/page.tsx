...
export const metadata: Metadata = {
  title: 'Reset Password – Resumly',
  description: 'Reset your Resumly account password.',
  robots: 'noindex',
};
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[480px] xl:w-[540px] bg-primary relative flex-col justify-between p-12 overflow-hidden flex-shrink-0">
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-[36px] leading-[1.2] font-medium text-white tracking-tight mb-5">Don&apos;t worry,<br />we&apos;ve got you</h2>
          <p className="text-white/70 text-[17px] leading-relaxed max-w-[360px]">Enter your email and we&apos;ll send you a link to reset your password.</p>
        </div>
        <div className="relative z-10 space-y-4">
          {['Secure password reset', 'Check your email for the link', 'Set a new password instantly'].map((text) => (
      ...
      <div className="flex-1 bg-white flex items-center justify-center p-6 sm:p-8">
        <div className="w-full max-w-[420px]">
          ...
          <div className="mb-8">
            <h1 className="text-[28px] font-medium text-neutral-90 tracking-tight">Reset password</h1>
            <p className="text-neutral-50 mt-1.5 text-[15px]">Enter your email and we&apos;ll send you a reset link</p>
          </div>
